...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        let totalSum = 0;
        try {
            const data = yield promises_1.default.readFile(path.join(__dirname, "inputData.txt"), "utf8");
            ...
            if (matches) {
                matches.forEach((match) => {
                    ...
                    const secondNumber = match.substring(firstNumberEnd + 1, secondNumberEnd);
